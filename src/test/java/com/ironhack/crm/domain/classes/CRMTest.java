...
class CRMTest {
    ...
    @AfterEach
    void tearDown(){
        LeadManagerImpl.getInstance().removeLead(lead1.getId());
        LeadManagerImpl.getInstance().removeLead(lead2.getId());
    ...
    void convertLeadToOpportunityTest() {
        ...
        crm.convertLeadToOpportunity(lead1.getId().toString(), product, 2, "ES000222", 002, "0023", "001");
        ...
        AccountManagerImpl.getInstance().deleteAccount(account.getId());
